...
const addStudent = () => {
  const newStudent = {
    ...
    dateOfBirth: new Date(studentInfo.dateOfBirth).toJSON(),
  ...
  studentStore.addItem(newStudent);
...
<template>
  <div class="">
    <div class="flex items-center justify-between">
      <Header :title="`Yangi o'quvchi qo'shish`" />
      <Menu />
    </div>
    ...
    <form @submit.prevent="addStudent">
      <div class="bg-white rounded-[20px] mt-[50px]">
        ...
        <div class="flex items-center justify-end p-[40px]">
          ...
          >
            <h5 class="text-[18px] leading-[27px] text-white">QO'SHISH</h5>
          </button>
        </div>
      </div>
    </form>
